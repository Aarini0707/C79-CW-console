...
console.log(name_of_the_student_array);
document.getElementById("display_names").innerHTML=name_of_the_student_array;
document.getElementById("name_of_the_student_1").innerHTML="";
document.getElementById("name_of_the_student_2").innerHTML="";
document.getElementById("name_of_the_student_3").innerHTML="";
document.getElementById("name_of_the_student_4").innerHTML="";
